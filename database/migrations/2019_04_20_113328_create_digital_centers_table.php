...
class CreateDigitalCentersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('digital_centers', function (Blueprint $table) {
            ...
            $table->double('transaction_amount', 8,3)->nullable();
            $table->double('profit_amount', 8,3)->nullable();
    ...
    {
        Schema::dropIfExists('digital_centers');
    }
}
