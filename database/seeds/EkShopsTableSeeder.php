...
use App\EkShop;
use App\Area;
class EkShopsTableSeeder extends Seeder
{
    /**
        ...
        for ($i=0;$i<500;$i++) {
            ...
            EkShop::updateOrCreate(
                [
                    ...
                    'no_of_order_delivery'=>$no_of_order_delivaery,
                    'no_of_partner'=>rand(1, 20),
                    'total_transaction'=>$total_transaction,
                    'total_profit'=>$profit,
                    'total_udc_covered'=>rand(1, 500),
                    'no_of_product_deliverd_with_period'=>$no_of_product_deliverd_with_period,
                    'data'=>null
                ]);
        }
    }
