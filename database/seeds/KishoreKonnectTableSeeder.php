...
use App\Area;
use App\KishoreKonnect;

class KishoreKonnectTableSeeder extends Seeder
{
    /**
    ...
    public function insert_data($date){
        ...
        for ($i=0;$i<64;$i++) {
            ...
            KishoreKonnect::updateOrCreate(
                ...
                'total_register_student'=>$total_register_user,
                'total_active_student'=>$total_user_enrolled_course,
                'total_register_studet_hit_monthly'=>$total_user_complete_course,
                'data'=>null
            ]);
        }
    }
