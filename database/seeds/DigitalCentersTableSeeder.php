...
use App\DigitalCenter;
use App\Area;

class DigitalCentersTableSeeder extends Seeder
{
    /**
    ...
    public function insert_data($date){
        ...
        for ($i=0;$i<500;$i++){
            ...
            DigitalCenter::updateOrCreate(
                ...
                'provider_id'=>rand(0,1),
                'entrepreneur_id'=>rand(1,10),
                'center_id'=>rand(1,10),
                'no_of_service_delivery'=>rand(1,10),
                'service_creator_id'=>rand(0,1),
                'service_type_id'=>1,
                'process_id'=>rand(1,2),
                'transaction_amount'=>rand(10000,50000),
                'profit_amount'=>rand(1000,9000),
