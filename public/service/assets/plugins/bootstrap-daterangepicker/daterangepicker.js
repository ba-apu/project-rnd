...
(function(root, factory) {
	console.log("11 daterangepicker start here");
  ...
  // Finally, as a browser global.
	...
	console.log(" 35 daterangepicker start here");
    var DateRangePicker = function (element, options, cb) {
        ...
        if (typeof options !== 'object' || options === null)
            options = {};
		console.log("70 daterangepicker start here");
	...
	console.log("123 daterangepicker start here");
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
			...
			console.log("325 daterangepicker start here");
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, side) {
            ...
            var i;
			console.log("1105 daterangepicker start here");
            if (this.timePicker) {
	...
	console.log("1248 daterangepicker start here");
