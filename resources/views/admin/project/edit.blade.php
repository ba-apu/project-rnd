                ...
                <div class="card-block">
                    ...
                    role="form" method="POST" enctype="multipart/form-data" data-toggle="validator">
                        ...
                        <div class="form-group{{ $errors->has('reference_child_table_name') ? ' has-error' : '' }}">
                            <label for="reference_child_table_name" class="col-lg-4 control-label">সংযুক্ত টেবিল ১(লিখার ভিতরে কোনো ফাঁকা জায়গা রাখা যাবে না: xyz_abc)</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('reference_child_2_table_name') ? ' has-error' : '' }}">
                            <label for="reference_child_2_table_name" class="col-lg-4 control-label">সংযুক্ত টেবিল ২(লিখার ভিতরে কোনো ফাঁকা জায়গা রাখা যাবে না: xyz_abc)</label>
                            <div class="col-md-6">
                    ...
                    <!-- <div class="form-group{{ $errors->has('main_indicator') ? ' has-error' : '' }}">
                        <label for="main_indicator" class="col-lg-4 control-label">প্রাইমারি ইন্ডিকেটর </label>
