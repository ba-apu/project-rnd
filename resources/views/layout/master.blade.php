...
<head>
    ...
    <link class="main-stylesheet" href="{{ custom_asset('assets/css/style.css') }}" rel="stylesheet" type="text/css" />
	@stack('css')
</head>
    ...
    <div class="header-inner header-md-height">
        ...
        <div class="">
            <div class="brand inline no-border hidden-xs-down">
                ...
                <img src="{{ custom_asset('assets/img/logo_white_new.png') }}" alt="logo" width="78" height="22"> <!-- data-src="{{ custom_asset('assets/img/logo_white_2x.png') }}" data-src-retina="{{ custom_asset('assets/img/logo_white_2x.png') }}"  -->
            </div>
                                    ...
                                    <div class="notification-item unread clearfix">
                                        ...
                                        <div class="heading open">
                                            <a href="#" class="text-complete pull-left">
                                                ...
                                                <span class="fs-12 m-l-10">স্বরন মাহমুদ</span>
                                            </a>
                                    ...
                                    <div class="notification-item unread clearfix">
                                        <div class="heading">
                                            <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                                                <img width="30" height="30" data-src-retina="{{ custom_asset('assets/img/profiles/1x.jpg') }}" data-src="{{ custom_asset('assets/img/profiles/1.jpg') }}" alt="" src="{{ custom_asset("assets/img/profiles/1.jpg") }}">
                                            </div>
                                            <a href="#" class="text-complete pull-left">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="pull-left p-r-10 fs-14 font-heading hidden-md-down text-white">
                <span class="semi-bold">স্বরন </span> <span class="">মাহমুদ</span>
            </div>
            <div class="dropdown pull-right">
                <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ui</button>
              <span class="thumbnail-wrapper d32 circular inline sm-m-r-5">
                <img src="{{ custom_asset('assets/img/profiles/avatar.jpg') }}" alt="" data-src="assets/img/profiles/avatar.jpg" data-src-retina="assets/img/profiles/avatar_small2x.jpg" width="32" height="32">
                </span>
                </button>
                ...
                <div class="view bg-white">
                    ...
                    <div data-init-list-view="ioslist" class="list-view boreded no-top-border">
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/1x.jpg" data-src="assets/img/profiles/1.jpg" src="{{ custom_asset("assets/img/profiles/1x.jpg") }}" class="col-top">
                        </span>
                                        <p class="p-l-10 ">
                    ...
                    <div class="chat-inner" id="my-conversation">
                        ...
                        <div class="message clearfix">
                            <div class="profile-img-wrapper m-t-5 inline">
                                <img class="col-top" width="30" height="30" src="{{ custom_asset("assets/img/profiles/avatar_small.jpg") }}" alt="" data-src="{{ custom_asset("assets/img/profiles/avatar_small.jpg") }}" data-src-retina="assets/img/profiles/avatar_small2x.jpg">
                            </div>
                        ...
                        <div class="message clearfix">
                            <div class="profile-img-wrapper m-t-5 inline">
                                <img class="col-top" width="30" height="30" src="{{ custom_asset("assets/img/profiles/avatar_small.jpg") }}" alt="" data-src="assets/img/profiles/avatar_small.jpg" data-src-retina="assets/img/profiles/avatar_small2x.jpg">
                            </div>
                            <div class="chat-bubble from-them">
                                Yea
                            </div>
...
<div class="overlay hide" data-pages="search">
    ...
    <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
            <!-- BEGIN Overlay Logo !-->
            <img class="overlay-brand" src="{{ custom_asset("assets/img/logo.png") }}" alt="logo" data-src="assets/img/logo.png" data-src-retina="assets/img/logo_2x.png" width="78" height="22">
            <!-- END Overlay Logo !-->
            <!-- BEGIN Overlay Close !-->
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            ...
                            <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                                <div>
                                    <img width="50" height="50" src="{{ custom_asset("assets/img/profiles/avatar.jpg") }}" data-src="assets/img/profiles/avatar.jpg" data-src-retina="assets/img/profiles/avatar2x.jpg" alt="">
                                </div>
                            </div>
