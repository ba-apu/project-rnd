...
<head>
    ...
    <link href="{{ custom_asset('assets/plugins/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
...
<div class="login-wrapper ">
    ...
    <div class="bg-pic">
        ...
        <img src="{{ custom_asset('assets/img/gallery/season-pic/sarat/2.jpg') }}"
             data-src="{{ custom_asset('assets/img/gallery/season-pic/sarat/2.jpg') }}"
             data-src-retina="{{ custom_asset('assets/img/gallery/season-pic/sarat/2.jpg') }}" alt=""
             class="lazy">
        <!-- END Background Pic-->
        <!-- START Background Caption-->
        @php
        $date = \App\BanglaCalendar::convertToBgCal();
        @endphp
        <div class="bg-caption pull-bottom sm-pull-bottom text-white p-l-20 m-b-20">
            <div class="txt-64 m-b-20"> {{ @$date->bdSeason }} কাল </div>
            <div class="txt-24 m-b-10">{{ @$date->bdDate.', '.@$date->bdYear  }}</div>
            <div class="txt-18 clearfix">{{ @$date->enDate }}</div>
        </div>
    ...
    <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
            <img src="{{ custom_asset('assets/img/logo.png') }}" alt="logo" data-src="{{ custom_asset('assets/img/logo.png') }}"
                 data-src-retina="{{ custom_asset('assets/img/logo_2x.png') }}" width="35%" >
            <!-- START Login Form -->
            ...
            <form method="POST" id="form-login" class="p-t-15" role="form" action="{{ route('login') }}">
                ...
                <div class="form-group form-group-default">
                    <label for="email" class="">{{ __('ই-মেইল') }}</label>
                    <div class="controls">
                        <input id="email" type="email" placeholder="xxxxx-xxxxxx" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                ...
                <!-- START Form Control-->
                <div class="form-group form-group-default">
                    <label for="password" class="">{{ __('পাসওয়ার্ড') }}</label>
                    <div class="controls">

                        <input id="password" type="password" placeholder="******" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required autocomplete="current-password">
                ...
                <div class="row">
                    <div class="col-md-6 no-padding sm-p-l-10">
                        <div class="checkbox ">
                            ...
                            <input class="re-check" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>

                            <label class="form-check-label" for="remember">
                                {{ __('আগামী ৩০দিন লগইন রাখুন') }}
                            </label>
                    ...
                    <div class="col-md-6 d-flex align-items-center justify-content-end">
                        <a href="#" class="text-info small">কোন সমস্যা?</a>
                    </div>
                </div>
                <!-- END Form Control-->
                <button class="btn btn-primary btn-cons m-t-10" type="submit">{{ __('লগইন') }}</button>
                <!-- <div class="m-t-10"><a href="#" class="text-info small">নতুন আকাউন্ট তৈরী</a></div> -->
            </form>
            ...
            <div class="pull-bottom ">
                <div class="m-b-30 p-r-80 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix">
                    <div class="col-sm-3 col-md-2 no-padding">
                        <!--img alt="" class="m-t-5" data-src="{{ custom_asset('assets/img/demo/pages_icon.png') }}"
                             data-src-retina="{{ custom_asset('assets/img/demo/pages_icon_2x.png') }}" height="60"
                             src="{{ custom_asset('assets/img/demo/pages_icon.png') }}" width="60"-->
                    </div>
                </div>
            </div>
        </div>
...
<div class="overlay hide" data-pages="search">
    ...
    <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
            <!-- BEGIN Overlay Logo !-->
            <img class="overlay-brand" src="{{ custom_asset('assets/img/logo.png') }}" alt="logo" data-src="{{ custom_asset('assets/img/logo.png') }}"
                 data-src-retina="{{ custom_asset('assets/img/logo_2x.png') }}" width="78" height="22">
            <!-- END Overlay Logo !-->
            <!-- BEGIN Overlay Close !-->
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            ...
                            <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                                <div>
                                    <img width="50" height="50" src="{{ custom_asset('assets/img/profiles/avatar.jpg') }}"
                                         data-src="{{ custom_asset('assets/img/profiles/avatar.jpg') }}"
                                         data-src-retina="{{ custom_asset('assets/img/profiles/avatar2x.jpg') }}" alt="">
                                </div>
                            </div>
