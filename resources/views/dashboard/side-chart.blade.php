...
<div class="row h-100">
    <div class="col-2">
        <span class="title_fp text-center">TOR<br> পর্যায়ে  আছে </span>
    </div>
    ...
    <div class="col-2 b-b">
        ...
        <span class="title_fp text-center">EOI<br> পর্যায়ে  আছে </span>
    </div>
    <div class="col-2 b pink b-r b-b">
        <span class="top-text">@lang('lavel.prolonged')</span>
    </div>
    <div class="col-2 b-b">
        ...
        <span class="title_fp text-center">Work Order<br> পর্যায়ে  আছে </span>
    </div>
</div>
<div class="row">
